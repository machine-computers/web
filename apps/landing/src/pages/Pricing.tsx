...
const pricingTiers = [
  ...
  },
  {
    ...
    description: "Deploy on your infrastructure with complete control while maintaining frontier-grade capabilities.",
    basePrice: "Custom",
    savingsRange: "40-65%", 
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="py-24 bg-accent text-accent-foreground relative overflow-hidden">
          {/* Geometric shapes */}
          <div className="absolute top-10 right-10 w-24 h-24 border-4 border-accent-foreground/20 transform rotate-45" />
          <div className="absolute bottom-20 left-20 w-16 h-16 bg-accent-foreground/10" />
          <div className="absolute top-1/2 right-1/4 w-12 h-12 border-4 border-accent-foreground/15" />
          ...
          <div className="container mx-auto px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16 space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold font-mono uppercase tracking-tight">
                Compute Power
                <br />
                <span className="text-accent-foreground/80">Priced Right</span>
              </h1>
              <p className="text-xl lg:text-2xl max-w-3xl mx-auto font-mono leading-relaxed opacity-90">
                Pay for compute power, not hardware overhead. Transparent pricing that scales with your frontier ambitions.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-background border-4 border-text-primary p-12 text-center">
              <div className="max-w-3xl mx-auto space-y-6">
                ...
                <h3 className="text-3xl font-bold text-text-primary font-mono uppercase">
                  Calculate Your Frontier Savings
                </h3>
